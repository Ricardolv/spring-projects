...
INSERT INTO state (code, name, initials) VALUES (1,'Acre', 'AC');
INSERT INTO state (code, name, initials) VALUES (2,'Bahia', 'BA');
INSERT INTO state (code, name, initials) VALUES (3,'Goiás', 'GO');
INSERT INTO state (code, name, initials) VALUES (4,'Minas Gerais', 'MG');
INSERT INTO state (code, name, initials) VALUES (5,'Santa Catarina', 'SC');
INSERT INTO state (code, name, initials) VALUES (6,'São Paulo', 'SP');
