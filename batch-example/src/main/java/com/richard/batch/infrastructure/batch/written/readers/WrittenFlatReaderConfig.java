...
@Configuration
public class WrittenFlatReaderConfig {

    @StepScope
    @Bean
    public FlatFileItemReader<Client> writtenFlatReader(
            @Value("#{jobParameters['fileClientsFlat']}") Resource fileClientsFlat) {
        return new FlatFileItemReaderBuilder<Client>()
                .name("writtenFlatReader")
                .resource(fileClientsFlat)
                .fixedLength()
