...
public class FileMultipleClientTransactionReader implements ItemStreamReader<Client>, ResourceAwareItemReaderItemStream<Client> {
    private Object objectCurrent;
    private FlatFileItemReader<Object> delegate;

    public FileMultipleClientTransactionReader(FlatFileItemReader<Object> delegate) {
