...
public class User extends AbstractVersionedEntity<UserId> {
    ...
    private User(UserId id, Set<UserRole> roles, UserName userName, String password, Gender gender,
    ...
    public static User createUser(UserId id, UserName userName, String encodedPassword,
    ...
    public static User createAdministrator(UserId id, UserName userName, String encodedPassword,
                                           Gender gender, LocalDate birthday, Email email,
                                           PhoneNumber phoneNumber) {
